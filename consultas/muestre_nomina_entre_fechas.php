...
*/
$sql_mecanicos_con_items  = "
select id_mecanico as mecanico from $tabla15 io 
...
<?php
echo '<br>consulta<br>'.$sql_mecanicos_con_items;
echo '<h3>RESUMEN NOMINA  DEL '.$_REQUEST['fechain'].'  AL '.$_REQUEST['fechafin'].'</h3> ';

 $gran_total = 0;
$consulta_ordenes_fecha = mysql_query($sql_mecanicos_con_items,$conexion);
