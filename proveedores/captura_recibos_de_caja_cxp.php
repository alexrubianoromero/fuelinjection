...
$datos_proveedor= consulta_assoc($proveedores,'idcliente',$datos_cxp['id_tecnico'],$conexion);
...
<table width="95%" border="1">
  ...
  <tr>
    <td>
	 ...
	 ?>	</td>
    <td><label>
      <input name="dequienoaquin" type="text"  id = "dequienoaquin" size="40%" value="<?php echo $datos_proveedor['nombre'] ?>">
