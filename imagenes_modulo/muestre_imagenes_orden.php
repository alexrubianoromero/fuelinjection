...
echo '<BR>';echo '<BR>';
?>
<a href ="../menu_principal.php"><span class="style2">MENU PRINCIPAL</span><a/>
<BR>
<BR>
	<?php
echo '<a href="captura_imagen.php?idorden='.$_REQUEST['idorden'].'"><span class="style2">NUEVA_IMAGEN</span></a>';
...
while($imagenes = mysql_fetch_assoc($consulta_imagenes))
		{
			echo '<tr>';
			echo '<td>'.$imagenes['descripcion'].'</td>';
