...
echo '<table border= "1">';
	echo '<td><h3>No Orden<h3></td><td><h3>Marca./Modelo</h3></td><td><h3>Fecha</h3></td><td><h3>Placa</h3></td>';
	echo '<td><H3>MOD</H3></td>';
	echo '<td><h3>Accion</h3></td>
<td><h3>modificar</h3></td><td><h3>Ficha Tecnica </h3></td><td><h3>Vista Impresion</h3></td><td><h3>Vista Impresion 2</h3></td>  <td><h3>Estado</h3></td><td><h3>facturar</h3></td>'; 
		...
		while($ordenes = mysql_fetch_array($consulta_ordenes))
			{
				...
				echo  '<td><h3>';
					if($ordenes['5'] < 1)
					{echo '<a href="../facturas/muestre_listado_ordenes_pendientes_por_facturar.php?placa123='.$ordenes[2].'">facturar</a>';}
					if($ordenes['5'] >0)
					{echo 'Facturada';}
				echo '</h3></td>'; 
					echo  '<td><h3>';
					if($ordenes['5'] < 1)
					{echo '<a href="../facturas/facturar_nuevo.php?id_orden='.$ordenes[0].'">crear_fac</a>';}
					if($ordenes['5'] >0)
					{
