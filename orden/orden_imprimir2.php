...
$tamano_letra ="10px";
$tamano_letra_items ="8px";
$tamano_letra_condicioes ="7px";
/*
...
$sql_placas = "select cli.nombre,cli.identi,cli.direccion,cli.telefono,car.placa,car.marca,car.modelo,car.color,car.tipo,
 o.fecha,o.observaciones,o.radio,o.antena,o.repuesto,o.herramienta,o.otros,o.iva as iva ,o.orden,o.kilometraje,o.mecanico,o.id,o.nivel_gasolina,
...
<div id = "divorden" align="center">
  <form action="" method="post">
    <table border = "1" width="<?php  echo $ancho_tabla;  ?>"  style="font-size:<?php echo $tamano_letra; ?>">
      ...
      value = "<? echo $nombre_mecanico  ?>" ></td><td>&nbsp;</td>
	  <td>KILOMETRAJE</td>
	  <td><input name="kilometraje"  id = "kilometraje"  type="text" size="20" value = "<? echo $datos[0]['kilometraje']  ?>" ></td></tr><tr>
	...
	<?php
	if($datos[0]['nivel_gasolina']== 0) {$nivel_gasolina = 'Vacio';}
	if($datos[0]['nivel_gasolina']== 1){$nivel_gasolina = '1/4';}
	if($datos[0]['nivel_gasolina']== 2){$nivel_gasolina = '1/2';}
	if($datos[0]['nivel_gasolina']== 3){$nivel_gasolina = '3/4';}
	if($datos[0]['nivel_gasolina']== 4){$nivel_gasolina = 'Lleno';}
  
	?>
	<table border = "1" width="<?php  echo $ancho_tabla;  ?>"  style="font-size:<?php echo $tamano_letra; ?>">
	<tr>
	<td>NIVEL GASOLINA   <?php  echo $nivel_gasolina; ?></td>
	</tr>
	</table>
   <table border = "1" width="<?php  echo $ancho_tabla;  ?>"  style="font-size:<?php echo $tamano_letra; ?>">
  <tr>
    <td><br><br>
	_______________________________________<br>Firma CLiente 
	</td>
  </tr>
</table>
<br>
<table border = "1" width="<?php  echo $ancho_tabla;  ?>"  style="font-size:<?php echo $tamano_letra; ?>">
  <tr>
    <td>CONDICIONES:<BR>
	1. Los materiales y piezas de repuestos son suministrados por la empresa salvo estipulacion en el contrato<br>
  2. La empresa queda autorizada para realizar las pruebas  necesarias del vehiculo mientras este pendiente la concicliacion de la cuenta.<br>
  3. La empresa queda facultada para ejercer el derecho  de retencion del vechiculo mientras este pendiente la cancelacion de la cuenta.<br>
  4. Es entendido que quien contrata y ordena el trabajo del vehiculo es el propietario de este o esta autorizado por el propietario del mismo <br>
  5. Despues de dos dias de confirmada la terminacion del trabajo la empresa queda autorizada a cobrar $14.500 pesos diarios por parqueadero<br>
  6. El taller no se reaponsabiliza por daños, hurto,robo, incendio  o cualquier causa de fuerza mayor que ocurra dentro de las instalaciones o en las pruebas que se ejecuten fuera del taller.
...
<br>
<table border = "0" width="<?php  echo $ancho_tabla;  ?>"  style="font-size:<?php echo $tamano_letra; ?>">
  <tr>
    <td align="center">CALLE 128 C No 53-46  TELS: 6263101 - 626 30 85 - CEL: 3112178901- 3188135154</td>
  </tr>
</table>
