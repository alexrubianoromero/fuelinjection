...
$sql_grabar_item = "insert into $tabla15 (no_factura,codigo,descripcion,cantidad,total_item,valor_unitario,
	id_empresa,estado,valor_mecanico,id_mecanico)
...
,'".$_REQUEST['valor_mecanico']."'
,'".$_REQUEST['id_mecanico_item']."'
