...
<div id="Layer2"> <img src="<?php  echo $ruta_imagen    ?>" width="268" height="92"></div>
...
<table width="95%" border="0">
  ...
  <tr>
    <td><h9>
      <div align="center">GRUPO EMPRESARIAL BALCAZAR S.A.S. NIT: 900861474-6 </div>
    </h9></td>
    <td><h9>
      <div align="center">
        <?php  echo $linea2;  ?>
  ...
  <tr>
    <td><h9>
      <div align="center">Cra 36 # 1F-80 TEL: 3607013 CEL 3105860897</div>
    </h9></td>
  ...
  <tr>
    <td><h9>
      <div align="center">LUNES A SABADO DE 8:00 AM A 6:00 PM</div>
    </h9></td>
    <td><h8>
      <div align="center">
        <?php
  ...
  <tr>
    <td><h9>
      <div align="center">OILTEAM.F1@GMAIL.COM</div>
    </h9></td>
    <td><h8>
...
<table width="95%" border="1">
  <tr>
    ...
    <td width="12%"><?php echo substr($datos[0]['modelo'],0,30)?></h8></td>
...
<tr>
    ...
    <td width="13%"><h8>
	<div align = "right">
    <?php  echo '$'.number_format($datos[0]['subtotalfac'], 0, ',', '.') ?>
	</div>
    </h8></td>
  </tr>
<tr>
  <td>
  <h8><div align="center">IVA </div></h8>
  </td>
    <td width="5%"><h8>
	</td>
  <td><h8>
...
<tr>
  <td> <h8><div align="center">RETEFUENTE </div></h8></td>
  <td>&nbsp;</td>
  <td><h8>
	<div align = "right">
