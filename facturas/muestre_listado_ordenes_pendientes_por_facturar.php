...
$sql_listado_ordenes = "select id,fecha,orden from $tabla14 where placa = '".$_REQUEST['placa123']."' and id_empresa = '".$_SESSION['id_empresa']."' and estado = '0' and anulado ='0' ";
//echo '<br>ordenes<br>'.$sql_listado_ordenes;
$consulta_ordenes = mysql_query($sql_listado_ordenes,$conexion);
echo '<H2>ORDENES SIN DOCUMENTO SOPORTE PLACA   </H2'.'<h2>'.$_REQUEST['placa123'].'</h2>';
echo '<div id = "mostrar">';
