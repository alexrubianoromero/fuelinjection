...
<table width="95%" border="1">
  ...
  <tr>
    <td>
	 ...
	 ?>	</td>
    <td><label>
      <input name="dequienoaquin" type="text"  id = "dequienoaquin" size="40%">
    </label>  OPERARIO <select id = "id_mecanico" name = "id_mecanico" class="fila_llenar" >
    <option value ="0">Escoger Operario</option>
    <?php
