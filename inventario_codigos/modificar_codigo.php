...
<Div id="contenidos">
  ...
  <tr>
    ...
    <td width="208"><label>
     <h3> <input type="text" name="codigo"  id="codigo"  value = "<?php echo $codigos['codigo_producto']  ?>"  onfocus="blur()"><h3>
    </label></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td><h3>&nbsp;</h3></td>
    <td><input type="hidden" name="id_codigo"  id="id_codigo" value = "<?php echo $codigos['id_codigo']  ?>" ></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
