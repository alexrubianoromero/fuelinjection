...
function mostrar_items($factupan)
				...
				{		
						...
						echo '<table width="'.$ancho_tabla.'" border="1" class="table  table-striped table-hover">';
						...
						if ($numero_filas > 0 )
						{
							...
							echo '<tr>';
							  ...
							  echo '<tr><td></td><td></td><td></td><td></td><td>Subtotal Insumos</td><td align="right">'.$suma_aceites.'</td></tr>';
							  
							  echo '<tr><td></td><td></td><td></td><td></td><td>Subtotal Repuestos</td><td align="right">'.$suma_repuestos.'</td></tr>';
