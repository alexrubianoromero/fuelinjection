...
$insertar_cotizacion = "insert into $cotizaciones(no_cotizacion,idcarro,id_empresa,fecha,kilometraje,valor,observaciones)
values('".$_REQUEST['no_cotizacion']."','".$_REQUEST['idcarro']."','".$_REQUEST['id_empresa']."'
	,'".$_REQUEST['fecha']."'
