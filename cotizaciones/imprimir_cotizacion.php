...
$tamano_letra_tabla = "12px";
 function  consulta_assoc_coti_impre($tabla,$campo,$parametro,$conexion)
  {
  ...
  $datos_empresa = consulta_assoc_coti_impre($tabla10,'id_empresa',$_SESSION['id_empresa'],$conexion);
  $datos_cotizacion_123 = consulta_assoc_coti_impre($cotizaciones,'id_cotizacion',$_REQUEST['id_cotizacion'],$conexion);
?>
<!DOCTYPE html><head>
<meta charset="UTF-8"/>
...
<table width="<?php echo $ancho_tabla ?>" border="1"  style="font-size:<?php echo $tamano_letra_tabla;?>">
  <tr>
    <td><div align="center"><img src="../logos/fuelinjection.png" width="150" height="100"></div></td>
    <td><div id="titulos">
      <div align="center">COTIZACION No: <?php echo  $arr_cot['no_cotizacion']; ?><br>
        NIT: <?php  echo $datos_empresa['identi'] ?><BR>
        <?php  echo $datos_empresa['direccion'] ?></div>
    </div></td>
  </tr>
  <tr>
...
?>
 <tr align="center">
  ...
  <?php
$suma_aceites=mostrar_items_parametro($item_orden_cotizaciones,$_REQUEST['id_cotizacion'],'I',$conexion,$ancho_tabla);
...
-->
  <tr>
    ...
    <tr>
    <td colspan ='3' align="left">OBSERVACIONES: <?php   echo $datos_cotizacion_123['observaciones'] ; ?> </td>
   </tr> 
